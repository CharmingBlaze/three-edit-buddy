...
export function createSimpleCube(params: CubeParams = {}): EditableMesh {
  ...
  const v0 = builder.addVertex({ x: -halfWidth, y: -halfHeight, z: halfDepth }, 'v0');  // front-bottom-left
  const v1 = builder.addVertex({ x: halfWidth, y: -halfHeight, z: halfDepth }, 'v1');   // front-bottom-right
  const v2 = builder.addVertex({ x: halfWidth, y: halfHeight, z: halfDepth }, 'v2');    // front-top-right
  const v3 = builder.addVertex({ x: -halfWidth, y: halfHeight, z: halfDepth }, 'v3');   // front-top-left
  const v4 = builder.addVertex({ x: -halfWidth, y: -halfHeight, z: -halfDepth }, 'v4'); // back-bottom-left
  const v5 = builder.addVertex({ x: halfWidth, y: -halfHeight, z: -halfDepth }, 'v5');  // back-bottom-right
  const v6 = builder.addVertex({ x: halfWidth, y: halfHeight, z: -halfDepth }, 'v6');   // back-top-right
  const v7 = builder.addVertex({ x: -halfWidth, y: halfHeight, z: -halfDepth }, 'v7');  // back-top-left
